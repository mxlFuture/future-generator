...
public class GenerateInput implements Serializable {
	 ...
	 * 字段注释
	 */
	private List<String> beanFieldDesc;
	...
	public List<String> getBeanFieldDesc() {
		return beanFieldDesc;
	}

	public void setBeanFieldDesc(List<String> beanFieldDesc) {
		this.beanFieldDesc = beanFieldDesc;
	}
	...
	public String getServicePkgName() {
		return beanPackageName.replace("model", "service");
	}
	/**
	 * service类名
	 */
	...
	public String getServiceImplPkgName() {
		return beanPackageName.replace("model", "service")+".impl";
	}
}
